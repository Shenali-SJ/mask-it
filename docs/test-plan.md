...
| User pastes URL to www.example.net | `visit https://www.example.net` | `visit https://www.example.net` | `www.example.net URL not masked` |
...
| (update) | Same email or same URL repeated: deduplicate by value—repeated content gets the same placeholder number (e.g. two shenali@ifs.com → {{EMAIL:1}} and {{EMAIL:1}}). Added scenarios in §1.3. |
